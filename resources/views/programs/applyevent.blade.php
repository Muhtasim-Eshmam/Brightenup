                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <select id="for" name="for" class="form-control" required="required" data-error="Please specify your need." >                  
                                        <option value=""></option>
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                     <label for="form_need">Applying for</label>
                                     <select id="select" name="select" class="form-control" required="required" data-error="Please specify your need." >                  
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                     <label for="form_need">Applying for Event</label>
                                     <select id="select2" name="select2" class="form-control" required="required" data-error="Please specify your need." >                  
